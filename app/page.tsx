...
const LiveLyrics = ({ audioRef, currentSongIndex }: { audioRef: React.RefObject<HTMLAudioElement | null>, currentSongIndex: number }) => {
  ...
  { time: 60.05, text: "Oh no, I don't need you, but I miss you, come here" },
  { time: 66.2, text: "And oh, it's hard to see you, but I wish you were over here" },
  { time: 74.12, text: "Oh, it's hard to leave you when I get you everywhere, all this time I'm thinking I'm strong enough to sink it" },
  { time: 81.25, text: "Oh no, I don't need you, but I miss you, come here" },
  { time: 84.5, text: "He love me now, he loves me, he holds me tight then let me go" },
